...
export const nodeCategories = {
  ...
  'Data / RAG': [
    ...
    { type: 'dataLoaderNode', label: 'Data Loader', icon: Database, desc: "Load CSV/JSON" },
    ...
    { type: 'dataVisualizationNode', label: 'Data Visualizer', icon: Layers, desc: "Generate Charts" },
  ],
  'Helpers': [
