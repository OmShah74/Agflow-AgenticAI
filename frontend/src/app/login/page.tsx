...
export default function LoginPage(props: {
    ...
    const [params, setParams] = useState<{ message?: string; error?: string } | null>(null)
        ...
        <div className="h-screen flex flex-col items-center justify-center bg-slate-950 font-sans relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-slate-900/50 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-slate-800/50 z-10">
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-slate-400 mt-2">Sign in to continue to Agflow</p>
                </div>
                ...
                <form className="flex flex-col gap-5">
                    ...
                    {/* Messages Display */}
                    {params?.message && (
                        <div className="bg-green-500/10 border border-green-500/20 text-green-400 text-xs p-4 rounded-xl flex items-center gap-2">
